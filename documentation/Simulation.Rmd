...
**Prediction**: When using a fitted model with differentiation, the function `forecast_model()` raises a warning about using the original scale of data to compute puntual predictions.
