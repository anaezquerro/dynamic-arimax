...
```{r}
preds <- forecast_model(ajuste, h=10, mode='bootstrap', level=c(70, 80, 90))
display(plot_forecast(preds, rang=c(450, 510)), name='ejemplo1')
```
...
preds <- forecast_model(ajuste, h=10, mode='bootstrap', level=c(70, 80, 90))
display(plot_forecast(preds, rang=c(450, 510)), name='ejemplo2')
```
