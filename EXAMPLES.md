# Documentation and examples of use of the `dynamic-arimax` repository
...
```
![serie gripe](figures/serie%20gripe.png)
...
```
![residuals gripe](figures/residuals%20gripe.png)
